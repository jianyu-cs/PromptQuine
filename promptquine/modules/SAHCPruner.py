...
class SAHCPruner(Pruner):
    """The SAHCPruner class for SAHCPruning implementations."""
    ...
    def forward(self, prompt: Union[str, Dict], test_loader: Any, 
        ...
        while True:
            ...
            while counter < admissable_len:
                ...
                if performance/max_performance <= 1:
                    # cancel this masking
                    colorful_print(f"Keep the token, as {performance} is not larger than {max_performance}!", fg='blue')
